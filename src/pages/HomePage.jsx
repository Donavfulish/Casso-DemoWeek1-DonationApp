    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="max-w-md w-full space-y-8">
        <div className="text-center">
          <h1 className="text-4xl font-bold text-foreground mb-2">CAS-DONATE</h1>
          <p className="text-muted-foreground text-lg">Make donations simple</p>
        </div>

        <Card className="border-border bg-card">
          <CardHeader className="text-center">
            <CardTitle className="text-card-foreground">Get Started</CardTitle>
            <CardDescription>Choose your path to start using CAS-Donate</CardDescription>
          </CardHeader>
